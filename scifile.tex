...
Even for an experienced user, browsing this mass of data may be hazardous : when using categories of an article he has been interested in, as most of the articles belong to several of them it can be challenging to find, given a liked article, a similar article that is not redundant that the user is likely to be interested in. \\
